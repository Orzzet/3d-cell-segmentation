...
class MiniUNet3D(nn.Module):
    def __init__(self, in_channel, n_classes):
        ...
        self.ec3 = self.encoder(64, 128, bias=False, padding=0)
        self.ec4 = self.encoder(128, 128, bias=False, padding=0)
    ...
    def forward(self, x):
        ...
        s1 = x.size()[3]
        s2 = x.size()[4]
        self.interp = nn.Upsample(size = (s0, s1, s2), mode='trilinear', align_corners=True)
        d0 = self.interp(d0)
        return d0
...
class UNet3D(nn.Module):
    def __init__(self, in_channel, n_classes):
        ...
        self.ec0 = self.encoder(self.in_channel, 32, padding=1, bias=False, batchnorm=False)
        self.ec1 = self.encoder(32, 64, bias=False, padding=1,batchnorm=False)
        self.ec2 = self.encoder(64, 64, bias=False, padding=1,batchnorm=False)
        self.ec3 = self.encoder(64, 128, bias=False, padding=1, batchnorm=False)
        self.ec4 = self.encoder(128, 128, bias=False, padding=1,batchnorm=False)
        self.ec5 = self.encoder(128, 256, bias=False, padding=1,batchnorm=False)
        self.ec6 = self.encoder(256, 256, bias=False, padding=1,batchnorm=False)
        self.ec7 = self.encoder(256, 512, bias=False,padding=1, batchnorm=False)
